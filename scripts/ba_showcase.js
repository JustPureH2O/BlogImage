...
const students = [
    ...
    {name: "hikari", img: 7, init: "吵~死啦……", startup: 3, sentences: [{id: 1, prompt: "Sensei 你有什么事吗？"}, {id: 2, prompt: "Sensei 还是那么喜欢使唤小孩子", animation: "shake 0.1s"}, {id: 4, prompt: "も……Sensei 怎么跟小孩子一样把博客弄得乱糟糟的", animation: "shake 0.1s"}, {id: 5, prompt: "真是的，Sensei，会赶不上铁路交付日期的"}, {id: 6, prompt: "诶……这是送我的礼物吗……"}]},
    ...
    {name: "koharu", img: 8, init: "啊，Sen……Sensei，欢迎回来……", startup: 0, sentences: [{id: 1, prompt: "Sensei！小春来值日啦"}, {id: 2, prompt: "（唔，这么多文章，莫非……莫非是那种内容？？？）"}, {id: 3, prompt: "在……在我面前做坏事……绝对不会被原谅！"}, {id: 4, prompt: "真是的，Sensei 应该给学生做好榜样才对吧！", animation: "shake 0.1s"}, {id: 5, prompt: "（唔……不会是，H的事吧……）", animation: "shake 0.1s"}, {id: 6, prompt: "哇呀呀呀，H的事……达咩呀！！！", animation: "shake 0.1s"}, {id: 7, prompt: "Sensei……当众涩涩，可是死刑哦~", animation: "shake 0.1s"}]},
    {name: "noa", img: 5, init: "欢迎，Sensei，您要确认今天的安排吗？", startup: 0, sentences: [{id: 1, prompt: "请您不要在意，只是在观察您罢了"}, {id: 2, prompt: "（Sensei 的博客……原来有这么多内容吗？）"}, {id: 3, prompt: "Sensei 的博客，真应该好好整理一下了呢！"}, {id: 4, prompt: "呜哇，Sensei，请不要再说了！", animation: "shake 0.1s"}]},
    {name: "aris", img: 6, init: "新游戏即将贩售，Sensei 也会一起玩吧！", startup: 0, sentences: [{id: 1, prompt: "爱丽丝不吃电池……"}, {id: 2, prompt: "爱丽丝已经准备好和 Sensei 一起冒险了！"}, {id: 3, prompt: "爱丽丝来帮您打扫博客啦"}, {id: 4, prompt: "诶诶？爱丽丝不是打扫机器人！", animation: "shake 0.1s"}, {id: 5, prompt: "Sensei，不听话是不好的呦~"}]}
];
let arr = [];
